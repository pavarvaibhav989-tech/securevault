...
const { getRules, addRule, updateRule, deleteRule, toggleRule, simulatePacket, seedDefaults } = require('../controllers/firewallController');
...
router.patch('/rules/:id/toggle', protect, toggleRule);
